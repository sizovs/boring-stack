...
A note on performance: If you need to squeeze every bit from your web server, you can use [http server](https://github.com/uNetworking/uWebSockets.js/) that Bun is built on, while still running on battle-proven Node/V8.
