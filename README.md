...
A note on performance: If you need to squeeze every bit from your web server, you can use [http server](https://libs.tech/project/142631191/uwebsockets.js) that gives Bun a lead in benchmarks, while still running on battle-proven Node/V8.
